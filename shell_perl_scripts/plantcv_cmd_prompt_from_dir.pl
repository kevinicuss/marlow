...
# February 9 2021
# Cory Hirsch/Kevin Propst (little bit)
...
foreach my $files (@files_to_read) {
    print "$files\n";
    print $output_fh "python3.8 /Users/propst/Desktop/plantcv_pipeline_v3.14_2.1.py --image $files --pdfs /Users/propst/Documents/GitHub/Kevin/PlantCV/pipeline/pdfs.txt --outdir /Users/propst/Desktop/\n";
}
